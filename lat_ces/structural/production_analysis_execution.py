...
from lat_ces.structural.canonical_result import CanonicalStructuralResult, canonicalize_beam_solver_result
...
def run_production_structural_analysis(
    ...
    return ProductionStructuralResultBinding(model=request.model, result=canonical_result)
