...
only the new shell: top navigation, left context panel, central model workspace,
and the right-side "Umbrella" status panel.
"""
...
class LatCesInterface(tk.Tk):
    ...
    def _build(self) -> None:
        ...
        self.left_title = tk.Label(
            self.left, text="TAB OPTIONS", font=("Segoe UI", 12, "bold"),
            bg="#f4f8f9", fg="#244b5c"
        )
        ...
        tk.Label(
            self.center,
            text="REFERENCE HOUSE\n\nCentral model / working space\n\nThe building model remains the single source of identity.",
            font=("Segoe UI", 16),
            bg="#dff2f7",
            fg="#315565",
            justify="center",
...
__all__ = ["InterfaceFoundation", "LatCesInterface", "TABS", "main"]
