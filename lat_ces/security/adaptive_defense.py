...
class DefenseRecord:
    """Immutable evidence describing a security invariant learned from a role."""
...
class AdaptiveDefense:
    """Small, fail-closed knowledge boundary shared between active and standby roles.

    A failure produces a record. The standby role may quarantine that invariant
    immediately. Promotion to a persistent/shared defense requires a verified
    record, and import into another role accepts only an already-verified record.
    No code mutation or second security authority is performed here.
    """
