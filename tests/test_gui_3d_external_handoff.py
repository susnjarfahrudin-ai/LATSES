...
def test_scene1_exposes_external_3d_blender_handoff() -> None:
    ...
    assert "_scene2_presentation" in Scene1CompleteBuildingWorkspaceApp.export_scene3d_to_blender.__code__.co_names
    assert "export_blender_exchange" in Scene2PresentationExtension.__dict__
